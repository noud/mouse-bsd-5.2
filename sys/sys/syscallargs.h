...
check_syscall_args(sys___fhstat40)
...
int	sys___fhstat40(struct lwp *, const struct sys___fhstat40_args *, register_t *);
...
int	sys_vforkbreak(struct lwp *, const void *, register_t *);
